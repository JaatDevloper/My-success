...
# ---------- IMPORT FORCE SUBSCRIPTION FUNCTIONS FROM EXTERNAL MODULE ----------
# Import force subscription handler from forcesub.py
import forcesub
from forcesub import (
    check_user_subscription,
    send_force_subscription_message,
    join_command,
    check_subscription_filter,
    create_force_sub_handler
)
