...
def fetch_url_content(url):
    ...
    try:
        ...
        if 'google.com/amp' in url or 'ampproject.org' in url:
            try:
                ...
                amp_response = requests.get(url, headers=headers, timeout=10)
        ...
        # Try to get the content with a longer timeout for slow websites
...
def format_questions_for_bot(questions, category="Web Scraped"):
    ...
    for qa_pair in questions:
        ...
        if qa_pair['options']:
            ...
            # Generate appropriate options if none are available
            if contains_hindi:
                # Hindi options
                options = ["हां", "नहीं", "शायद", "पर्याप्त जानकारी नहीं"]
            else:
                # English options
