"""
Multi ID Quiz Bot with Direct Cloning Feature
This is a special version that directly hardcodes the Telegram API credentials
"""
import json
import logging
import os
...
# Import Telethon with direct credentials
...
# Telethon API credentials for quiz cloning - HARDCODED
API_ID = 28624690  # Hardcoded as integer
API_HASH = "67e6593b5a9b5ab20b11ccef6700af5f"  # Hardcoded string
PHONE_NUMBER = "+919351504990"  # Hardcoded string
...
async def initialize_telethon_client():
    """Initialize the Telethon client for quiz cloning - with direct hardcoded credentials"""
    ...
    try:
        ...
        if not await client.is_user_authorized():
            if PHONE_NUMBER:
                ...
                logger.warning("Phone number not provided. Cannot authenticate Telethon client.")
                return None
...
async def clone_quiz_from_quizbot(update, context, quiz_id, status_message):
    """Clone questions from @QuizBot with hardcoded credentials."""
    global telethon_client
