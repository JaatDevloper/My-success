    ...
    for page_text in text_list:
        ...
        while i < len(lines):
            ...
            # Check for options
                ...
                line.startswith('a)') or line.startswith('1)') or
                line.startswith('B)') or line.startswith('B.') or
                line.startswith('b)') or line.startswith('2)') or
                line.startswith('C)') or line.startswith('C.') or
                line.startswith('c)') or line.startswith('3)') or
                line.startswith('D)') or line.startswith('D.') or
                line.startswith('d)') or line.startswith('4)')
            ):
                option_text = line
            ...
            # Check for answer indication
                ...
                line.lower().startswith('ans:') or
                line.lower().startswith('answer:') or
                line.lower().startswith('correct answer:') or
                line.lower().startswith('correct:')
            ):
                # Extract correct answer index (A, B, C, D or 1, 2, 3, 4)
                answer_text = line.lower()
                if 'a' in answer_text or '1' in answer_text or 'option a' in answer_text:
                    current_question['answer'] = 0
                elif 'b' in answer_text or '2' in answer_text or 'option b' in answer_text:
                    current_question['answer'] = 1
                elif 'c' in answer_text or '3' in answer_text or 'option c' in answer_text:
                    current_question['answer'] = 2
                elif 'd' in answer_text or '4' in answer_text or 'option d' in answer_text:
