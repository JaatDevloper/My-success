...
async def quickscrape_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not args:
        await update.message.reply_text("Please provide a URL. Usage: /quickscrape [url]")
        return
    ...
    # Get the next available ID for the first question
    ...
    for q_data in questions_data:
        ...
        # Add to database with auto-incremented ID
