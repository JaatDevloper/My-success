    ...
    try:
        ...
        if not query:
            ...
            for quiz_id, quiz_data in all_questions.items():
                ...
                # PREMIUM BUTTONS: Enhanced button layout
                keyboard = [
                    [InlineKeyboardButton("🎯 Start Quiz Now", callback_data=f"start_quiz_{quiz_id}")],
                    [InlineKeyboardButton("🚀 Start Quiz in Group", callback_data=f"start_quiz_{quiz_id}")],
        ...
        # Process formatted queries like "quiz_ID" or "share_ID"
            ...
            if action == "quiz" or action == "share":
                ...
                # PREMIUM BUTTONS: Enhanced button layout with clear labels
                keyboard = [
                    [InlineKeyboardButton("🎯 Start Quiz Now", callback_data=f"start_quiz_{quiz_id}")],
                    [InlineKeyboardButton("🚀 Start Quiz in Group", callback_data=f"start_quiz_{quiz_id}")],
                    [InlineKeyboardButton("🔗 Share Quiz", switch_inline_query=f"quiz_{quiz_id}")]
