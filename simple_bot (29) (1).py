...
async def end_quiz(context, chat_id):
    ...
    # AUTO-RESET ALL USERS' NEGATIVE PENALTIES
    reset_success = reset_user_penalties()  # Reset all users' penalties
    
    # Add a note about reset penalties to the results message
    if reset_success:
        results_message += "\n✅ All negative penalties have been reset for the next quiz."
