    ...
    try:
        ...
        if save_premium_user(premium_user_id):
            await update.message.reply_text(
                ...
                f"User ID: <code>{premium_user_id}</code> has been given premium access.\n"
                f"They can now use all bot features without channel subscription.",
                parse_mode=ParseMode.HTML
            )
...
async def premium_status_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Handle the /premium_status command"""
    user_id = update.effective_user.id
    ...
    if user_id in PREMIUM_USERS:
        premium_status_message = (
            ...
            "• All quiz creation tools\n"
            "• PDF/TXT imports\n"
            "• Advanced analytics\n"
            "• Channel subscription bypass\n\n"
        ...
        non_premium_message = (
            ...
            "You currently don't have premium access to all features.\n\n"
            "💡 <b>Premium Benefits:</b>\n"
            "• Access to all quiz creation tools\n"
            "• Unlimited quiz imports from PDF/TXT\n"
            ...
            "<i>Copy your ID and send it to our admin!</i>"
        )
    ...
    try:
        ...
        try:
            await update.effective_message.reply_text(
                "This is a premium feature. Contact @JaatSuperme and share your ID to get premium access.",
            )
