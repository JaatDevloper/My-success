...
async def generate_questions_pdf(quiz_id, questions_list):
    ...
    try:
        ...
        if REPORTLAB_AVAILABLE:
            ...
            # Add custom style for Hindi text
            ...
            elements.append(Paragraph(f"Quiz Questions - {quiz_id}", title_style))
            ...
            for i, question_data in enumerate(questions_list, 1):
                ...
                # Question number
                elements.append(Paragraph(f"<b>Question {i}:</b>", styles["Heading3"]))
                ...
                if category:
                    ...
                    elements.append(Paragraph(f"<i>Category: {category}</i>", styles["Italic"]))
