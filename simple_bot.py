...
def generate_pdf_results(quiz_id, title=None, include_questions=True):
    """Generate PDF results for a quiz
    
    Args:
        quiz_id: The ID of the quiz
        title: Optional title for the PDF
        include_questions: Whether to include questions with correct answers (new feature)
...
def process_quiz_end(quiz_id, user_id, user_name, total_questions, correct_answers, 
                   wrong_answers, skipped, penalty, score, adjusted_score):
    """Process quiz end - add result and generate PDF with questions and correct answers"""
    # Add the quiz result to the database
    add_quiz_result(quiz_id, user_id, user_name, total_questions, correct_answers, 
                   wrong_answers, skipped, penalty, score, adjusted_score)
    
    # Generate PDF results with questions and correct answers
    pdf_file = generate_pdf_results(quiz_id, include_questions=True)
...
async def end_quiz(context, chat_id):
    ...
    # Inform users about PDF generation
    await context.bot.send_message(
        chat_id=chat_id,
