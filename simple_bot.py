...
async def add_question_start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if "new_question" in context.user_data:
        context.user_data.pop("new_question")
...
async def add_question_text(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logging.info(f"Received question: {update.message.text}")
    
    # Send a message asking for options
    await update.message.reply_html(
        "<b>📝 Question received!</b>\n\n"
        "Now, send me the <b>options with the correct answer marked with an asterisk (*)</b>.\n\n"
        "<i>Format each option with a letter prefix (A)-(D) and mark the correct answer with an asterisk (*). Example:</i>\n\n"
        "(A) Peacock *\n"
        "(B) Sparrow\n"
        "(C) Parrot\n"
        "(D) Eagle"
...
async def add_question_options(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    logging.info(f"Received options: {options_lines}")
...
async def category_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await query.edit_message_text(
        ...
        f"<b>Options:</b>\n{', '.join(new_question['options'])}\n\n" 
        f"<b>Answer:</b> {new_question['options'][new_question['answer']]}\n\n"
