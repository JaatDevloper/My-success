...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    welcome_text = (
        ...
        "Share in groups and track detailed performance with PDF results and statistics.\n\n"
...
async def features_command(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Create a stylish formatted showcase matching the screenshot exactly with bold formatting
    features_text = ""
    
    # Main title - using the quote style from screenshot with bold
    features_text += "<b>| 📘 Features Showcase of Negative Marking Quiz Bot! 🚀 |</b>\n\n"
    
    # Main features - using the blue diamond bullets from screenshot with bold feature names
    features_text += "🔹 <b>Create questions from text</b> just by providing a ✓ mark to the right options.\n"
    features_text += "🔹 <b>Marathon Quiz Mode:</b> Create unlimited questions for a never-ending challenge.\n"
    features_text += "🔹 <b>Convert Polls to Quizzes:</b> Simply forward polls (e.g., from @quizbot), and unnecessary elements like [1/100] will be auto-removed!\n"
    features_text += "🔹 <b>Smart Filtering:</b> Remove unwanted words (e.g., usernames, links) from forwarded polls.\n"
    features_text += "🔹 <b>Skip, Pause & Resume</b> ongoing quizzes anytime.\n"
    features_text += "🔹 <b>Bulk Question Support</b> via ChatGPT output.\n"
    features_text += "🔹 <b>Negative Marking</b> for accurate scoring.\n"
    features_text += "🔹 <b>Edit Existing Quizzes</b> with ease like shuffle title editing timer adding removing questions and many more.\n"
    features_text += "🔹 <b>Quiz Analytics:</b> View engagement, tracking how many users completed the quiz.\n"
    features_text += "🔹 <b>Inline Query Support:</b> Share quizzes directly in any chat, with percentile and percentage.\n"
    features_text += "🔹 <b>Create Questions from TXT.</b>\n"
    features_text += "🔹 <b>Advance Mechanism</b> with 99.99% uptime.\n"
    features_text += "🔹 <b>Automated link and username removal</b> from Poll's description and questions.\n"
    features_text += "🔹 <b>Auto txt quiz creation</b> from Wikipedia Britannica bbc news and 20+ articles sites.\n"
    
    # Latest updates section with styled header in bold
    features_text += "\n<b>| 🆕 Latest update new |</b>\n\n"
    
    features_text += "🔹 <b>Create Questions from Testbook App</b> by test link.\n"
    features_text += "🔹 <b>Auto clone</b> from official quizbot.\n"
    features_text += "🔹 <b>Create from polls/already finishrd quizzes</b> in channels and all.\n"
    
    # Upcoming features section with rocket in bold
    features_text += "\n<b>| 🚀 Upcoming Features: |</b>\n\n"
    
    features_text += "🔸 <b>Advance Engagement saving</b> + later on perspective.\n"
    features_text += "🔸 <b>More optimizations</b> for a smoother experience.\n"
    features_text += "🔸 <b>Suprising Updates...</b>\n"
    
    # Analytics section with chart icon in bold
    features_text += "\n<b>| 📊 Live Tracker & Analysis: |</b>\n\n"
    
    features_text += "✅ <b>Topper Comparisons</b>\n"
    features_text += "✅ <b>Detailed Quiz Performance Analytics</b>\n"
...
async def keep_alive():
    """Keep the bot awake on Render by sending regular pings"""
    while True:
        try:
            # Make a request every 14 minutes to prevent Render from sleeping
            # (Render free tier typically sleeps after 15 minutes of inactivity)
            await asyncio.sleep(14 * 60)  # 14 minutes in seconds
            logger.info("Keep-alive ping sent to prevent Render from sleeping")
        except Exception as e:
...
def main() -> None:
    ...
    # Start keep-alive mechanism to prevent sleeping on Render
