...
async def generate_questions_pdf(quiz_id, questions_list):
    ...
    try:
        # Import modules needed for PDF generation with Unicode support
        from reportlab.pdfgen import canvas
        ...
        logger.info("ReportLab modules imported successfully")
