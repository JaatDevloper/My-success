        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    minimal_pdf.cell(0, 10, 'Simple Quiz Results Report', 0, 1, 'C')
                    minimal_pdf.ln(10)
                    
                    minimal_filename = os.path.join(PDF_RESULTS_DIR, f"quiz_{quiz_id}_minimal.pdf")
                    minimal_pdf.output(minimal_filename, 'F')
                    logger.info(f"Created minimal PDF as fallback: {minimal_filename}")
                    return minimal_filename
                except:
                    logger.error("Failed to create even a minimal PDF")
                    return None
    except Exception as e:
